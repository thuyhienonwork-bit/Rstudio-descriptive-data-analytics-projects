...
1. Error Identification and Correction:
    Identify inconsistencies, duplicate records, and inaccurate data entries. Provide a clear explanation of how these errors were detected and rectified.

2. Handling Missing Values:
  - Identify missing data points and determine the best strategy to address them.
  - Discuss the methods used (Imputation).
  - Justify chosen approach.

3. Outlier Detection and Management:

- Identify potential outliers that may distort the analysis.
- Describe the method used to detect outliers, such as  Z-score, IQR, visualization techniques and others.
- Decide whether to remove, transform, or retain the outliers and justify your choice.

**Data Visualization:**
In this section, I explore the relationship between different variables. Your visualizations should effectively highlight patterns, trends, and relationships.

**Tasks:**
1. Select relevant variables to create relationships.
2. Create a total of 5 scenarios - meaning you must have 5 visualizations and/or tables to illustrate the important relationships. Use:
- Scatter plots for correlation analysis.
- Histograms or box plots for distribution insights.
- Bar charts or line graphs for trend analysis.
